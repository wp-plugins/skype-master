<?php
//Hook Widget
add_action( 'widgets_init', 'skype_master_widget_original_blue' );
//Register Widget
function skype_master_widget_original_blue() {
register_widget( 'skype_master_widget_original_blue' );
}

class skype_master_widget_original_blue extends WP_Widget {
	function skype_master_widget_original_blue() {
	$widget_ops = array( 'classname' => 'Skype Master Original Blue Buttons', 'description' => __('The perfect widget to display Original Blue Skype Action Buttons in your Wordpress Website and let users or customers contact you in a professional way. ', 'skype_master') );
	$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'skype_master_widget_original_blue' );
	parent::__construct( 'skype_master_widget_original_blue', __('Skype Master Original Blue Buttons', 'skype_master'), $widget_ops, $control_ops );
	}
...
//Display Buttons
	if ( $show_skype_vertical ){
		if ($show_skype_call){
		echo '<a href="skype:'.$skype_username.'?call"><img src="'.plugins_url('images/blue/call_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Skype Me" /></a><br>';
		}
		else {
		}
		if ($show_skype_chat){
		echo '<a href="skype:'.$skype_username.'?chat"><img src="'.plugins_url('images/blue/chat_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Chat with me" /></a><br>';
		}
		else {
		}
		if ($show_skype_add){
		echo '<a href="skype:'.$skype_username.'?add"><img src="'.plugins_url('images/blue/add_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Add me to Skype" /></a><br>';
		}
		else {
		}
		if ($show_skype_view){
		echo '<a href="skype:'.$skype_username.'?userinfo"><img src="'.plugins_url('images/blue/userinfo_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="View my profile" /></a><br>';
		}
		else {
		}
		if ($show_skype_voicemail){
		echo '<a href="skype:'.$skype_username.'?voicemail"><img src="'.plugins_url('images/blue/voicemail_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Leave me voicemail" /></a><br>';
		}
		else {
		}
		if ($show_skype_file){
		echo '<a href="skype:'.$skype_username.'?sendfile"><img src="'.plugins_url('images/blue/sendfile_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Send me a file" /></a>';
		}
		else {
		}
	}
		...
		if ($show_skype_call){
		echo '<a href="skype:'.$skype_username.'?call"><img src="'.plugins_url('images/blue/call_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Skype Me" /></a>';
		}
		else {
		}
		if ($show_skype_chat){
		echo '<a href="skype:'.$skype_username.'?chat"><img src="'.plugins_url('images/blue/chat_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Chat with me" /></a>';
		}
		else {
		}
		if ($show_skype_add){
		echo '<a href="skype:'.$skype_username.'?add"><img src="'.plugins_url('images/blue/add_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Add me to Skype" /></a>';
		}
		else {
		}
		if ($show_skype_view){
		echo '<a href="skype:'.$skype_username.'?userinfo"><img src="'.plugins_url('images/blue/userinfo_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="View my profile" /></a>';
		}
		else {
		}
		if ($show_skype_voicemail){
		echo '<a href="skype:'.$skype_username.'?voicemail"><img src="'.plugins_url('images/blue/voicemail_blue.png', dirname(__FILE__)).'" style="border: none;" height="23" alt="Leave me voicemail" /></a>';
		}
		else {
		}
		if ($show_skype_file){
