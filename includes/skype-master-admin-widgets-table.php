...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-skypemaster-admin-widget-original.png', __FILE__); ?>" alt="<?php echo get_option('skype_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-skypemaster-admin-widget-microsoft.png', __FILE__); ?>" alt="<?php echo get_option('skype_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-skypemaster-admin-widget-techgasp.png', __FILE__); ?>" alt="<?php echo get_option('skype_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-skypemaster-admin-widget-support.png', __FILE__); ?>" alt="<?php echo get_option('skype_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
			<td class="column-columnname"style="vertical-align:middle"><h3>Skype Support Widget</h3><p>This specially design widget is perfect to provide online support to your customers or users.</p><p>Displays your online status via 2 selectable support buttons.</p><p>Check the Add-ons Page.</p></td>
		</tr>
	</tbody>
</table>
<?php
