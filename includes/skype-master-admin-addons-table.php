...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-skypemaster-admin-addons-widget-original.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('skype_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
